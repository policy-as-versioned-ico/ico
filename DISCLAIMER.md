...
each entry names its source. Where a figure has since been reduced on appeal or never collected,
the schema records that as data (see the hub's ticket 79); a stale figure here is a defect to
correct, not a statement by the authority.
